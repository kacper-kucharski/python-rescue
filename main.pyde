...
def mousePressed():
    ...
    try:
        ...
        if scene == 0:
            deleteAllComponents()
            textFields.append(cp5.addTextfield("Player 1").setPosition(59,59).setSize(98,52).setFont(font).setColorBackground(color(255,0,0)))
            textFields.append(cp5.addTextfield("Player 2").setPosition(357,59).setSize(205,52).setFont(font).setColorBackground(color(255,0,0)))
            textFields.append(cp5.addTextfield("Player 3").setPosition(762,59).setSize(98,52).setFont(font).setColorBackground(color(255,0,0)))
            textFields.append(cp5.addTextfield("Player 4").setPosition(1060,59).setSize(161,59).setFont(font).setColorBackground(color(255,0,0)))
            textFields.append(cp5.addButton("Verder").setPosition(width/2 - 50,300).setSize(100,50).setFont(font).setColorBackground(color(255,0,0)))
