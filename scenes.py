...
def mainMenu(cp5, font, interactiveObjects, game):
    ...
    if game.playersTurn.currentPoints == game.maxPoints:
        pass
        interactiveObjects.append(cp5.addButton("Eind Vraag").setPosition(int(width* 0.05 ), int(height* 0.24 )).setSize(int(width* 0.28 ), int(height* 0.18 )).setFont(font).setColorBackground(color(131, 89, 73)).setColorActive(color(182, 123, 101)).setColorForeground(color(182, 123, 101)))
    else:
