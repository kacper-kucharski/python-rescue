...
def vraagScene(cp5, font, interactiveObjects):
    text("Vraag", 53, 37)
    interactiveObjects.append(cp5.addRadioButton("radioButton", width/2, height/2).setItemsPerRow(4).setSpacingColumn(35).addItem("ZET HIER VRAAG 1", 1.0).addItem("ZET HIER VRAAG 2", 2.0).addItem("ZET HIER VRAAG 3", 3.0).addItem("ZET HIER VRAAG 4", 3.0).setSize(50,50))
